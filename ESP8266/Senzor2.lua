...
print("Odesilam hodnoty:")

-- Measure temperature, humidity 
-- based on:https://github.com/ok1cdj/ESP8266-LUA/blob/master/Thermometer-DHT11-Thingspeak/dht11.lua
-- 2014 OK1CDJ
...
http.get("http://tymc15.jecool.net/www/api/pridat?key=t4m15&sid=TeplotaPokoj2&tmp="..Temperature.."."..TemperatureDec.."&vum="..Humidity.."."..HumidityDec)
print("odeslano")
